...
def main():
    ...
    parser.add_argument("--checkpoint-file", required=False, default="ai_core/tts/model/VI/female/hifigan/g_01140000")
    parser.add_argument("--config-file", required=False, default="i_core/tts/model/VI/female/hifigan/config.json")
    a = parser.parse_args()
